...
namespace FatecSisMed.MedicoAPI.Repositories.Entities
{
    public class MarcaRepository : IMarcaRepository
    {
        ...
        {
            return await _dbContext.Marcas.FirstOrDefaultAsync(mar => mar.Id == id);
        }

        public async Task<IEnumerable<Marca>> GetMarcaRemedios()
        {
            return await _dbContext.Marcas.Include(
            mar => mar.Remedios).ToListAsync();
        }

        public async Task<Marca> Remove(int id)
        {
